...
class UARTMonitor(QMainWindow):
    ...
    def _init_ui(self):
        ...
        # Set minimum window size to prevent content disappearing
        # Can be resized larger, but not smaller than this
    ...
    def _create_status_panel(self):
        ...
        panel.setMinimumWidth(280)  # Minimum genişlik belirle
        layout = QVBoxLayout()
        layout.setSpacing(8)
        ...
        for label in status_labels:
            ...
            btn.setMinimumWidth(240)  # Minimum genişlik
            btn.setStyleSheet(f"""
                QPushButton {{
                    background-color: {AppStyle.STATUS_DISABLED};
                    color: white;
    ...
    def _create_tx_controls(self):
        ...
        for i in range(4):
            ...
            btn.setMinimumWidth(220)  # Minimum genişlik
            btn.setStyleSheet(f"""
                QPushButton {{
    ...
    def _create_sata_controls(self):
        ...
        self.sata1_btn.setMinimumWidth(220)  # Minimum genişlik
        ...
        self.satas_btn.setMinimumWidth(220)  # Minimum genişlik
